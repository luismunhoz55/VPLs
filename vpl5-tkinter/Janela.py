...
class Janela(Tk):
  ...
  def __init__(self, Str="Janela"):
    super().__init__()
    super().title(Str)
    super().geometry("%dx%d+%d+%d" % (560, 200, 100, 100))
  ...
  def __init_text__(self):
    self.__Et_flamengo_pr.insert(END, "2.8")
    self.__Et_flamengo_sc.insert(END, "2.2")
    self.__Et_flamengo_rs.insert(END, "2.4")

    self.__Et_vasco_pr.insert(END, "2.2")
    self.__Et_vasco_sc.insert(END, "2.3")
    self.__Et_vasco_rs.insert(END, "2.5")
