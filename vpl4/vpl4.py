...
class Janela( Tk ): ## Questão 01: (Complete o código que declara a classe)
    ...
    def inicialize(self):
        ...
        self.__Lb_valor1.grid(row=0, column=0, stick=NW, padx=4, pady=4)
        self.__Lb_valor2.grid(row=1, column=0, stick=NW, padx=4, pady=4)
        
        self.__Et_valor1.grid(row=0, column=1, columnspan=4, stick=NW, padx=4, pady=4)
        self.__Et_valor2.grid(row=1, column=1, columnspan=4, stick=NW, padx=4, pady=4)
        
        self.__Bt_adic.grid(row=2, column=1, stick=NW, padx=4, pady=4)
        self.__Bt_sub.grid(row=2, column=2, stick=NW, padx=4, pady=4)
        self.__Bt_mult.grid(row=2, column=3, stick=NW, padx=4, pady=4)
        self.__Bt_div.grid(row=2, column=4, stick=NW, padx=4, pady=4)
        
        self.__Lb_result.grid(row=3, column=0, stick=NW, padx=4, pady=4)
        self.__Et_result.grid(row=3, column=1, columnspan=4, stick=NW, padx=4, pady=4)
